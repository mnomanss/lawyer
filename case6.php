...
<body>
  <div class="bg">
    ...
    <h1 id="head1">Property Sharing Case</h1>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="welcome_container">
            <h3>
              About the Property Sharing Case
            </h3>
            <div>
              <h4>
                Property Sharing
  ...
  <div class="side offset-9" id="card" style="margin-top:-650px;">
    <div class="card text-white bg-danger" style="max-width: 18rem;">
      ...
      <div class="card-body">
        <p class="text-center my-auto"><b>Category:</b> Property Sharing Case </p>
        <hr>
        <p class="text-center my-auto"><b>Time:</b> 6 month </p>
        <hr>
        <p class="text-center my-auto"><b>Lawyer:</b> Brian T. Fenimore </p>
        <hr>
