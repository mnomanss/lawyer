...
<body>
  <div class="bg">
    <img src="img/bg5.jpg" id="bg">
    <h1 id="head1">Weber & Partners case</h1>
  </div>
  ...
  <div class="side offset-9" id="card" style="margin-top:-600px;">
    <div class="card text-white bg-danger" style="max-width: 18rem;">
      <div class="card-header"><b>Case Info </b></div>
      <div class="card-body">
        <p class="text-center my-auto"><b>Category:</b> Weber & Partners Case </p>
        <hr>
        <p class="text-center my-auto"><b>Time:</b> 6 month </p>
        <hr>
        <p class="text-center my-auto"><b>Lawyer:</b> Dave R. Barnard </p>
        <hr>
        <p class="text-center my-auto"><b>Result:</b> $35k </p>
        <hr>
      </div>
    </div>
    <div class="case mt-5">
