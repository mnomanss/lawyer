...
<body>
  <div class="bg">
    <img src="img/bg4.jpg" id="bg">
    <h1 id="head1">Money Laundering case</h1>
  </div>
  ...
  <div class="side offset-9" id="card" style="margin-top:-650px;">
    <div class="card text-white bg-danger" style="max-width: 18rem;">
      ...
      <div class="card-body">
        <p class="text-center my-auto"><b>Category:</b> Money Laundering </p>
        <hr>
        <p class="text-center my-auto"><b>Time:</b> 5 month </p>
        <hr>
        <p class="text-center my-auto"><b>Lawyer:</b> Allan J. Sternstein </p>
        <hr>
        <p class="text-center my-auto"><b>Result:</b> $25k </p>
        <hr>
      </div>
    </div>
    <div class="case mt-5">
