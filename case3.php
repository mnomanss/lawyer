...
<body>
  <div class="bg">
    <img src="img/bg3.jpg" id="bg">
    <h1 id="head1">Divorce Case</h1>
  </div>
  ...
  <div class="side offset-9" id="card" style="margin-top:-650px;">
    <div class="card text-white bg-danger" style="max-width: 18rem;">
      ...
      <div class="card-body">
        <p class="text-center my-auto"><b>Category:</b> Divorce Case </p>
        <hr>
        <p class="text-center my-auto"><b>Time:</b> 9 month </p>
        <hr>
        <p class="text-center my-auto"><b>Lawyer:</b> Angela Ekker </p>
        <hr>
        <p class="text-center my-auto"><b>Result:</b> $45k </p>
        <hr>
      </div>
    </div>
    <div class="case mt-5">
